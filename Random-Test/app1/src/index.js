...
function Test(){
  ...
  var data = new Date()
  var strDate = data.toDateString();
  console.log(data.toDateString())
  
  var ti = new Date()
  var t1 = ti.toTimeString()
  console.log(t1)
...
function PushAllAvatar(){

  var [data=apiData , setData] = useState([]) ;
  ...
  return (
    ...
    <div>
      {apiData.map( (data)=>{
        ...
        return <Avatar name={data.login} dp={data.avatar_url} />;
    })}
    </div>
